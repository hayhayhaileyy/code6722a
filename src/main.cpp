...
ez::Drive chassis(
    ...
    {-7, -19, 8},     // Left Chassis Ports (negative port will reverse it!)
    {4, 13, -12},  // Right Chassis Ports (negative port will reverse it!)
...
void initialize() {
  ...
  chassis.opcontrol_drive_activebrake_set(3.0);   // Sets the active brake kP. We recommend ~2.  0 will disable.
  chassis.opcontrol_curve_default_set(2.0, 7);  // Defaults for curve. If using tank, only the first parameter is used. (Comment this line out if you have an SD card!)
...
void ez_screen_task() {
  while (true) {
      ...
      if (chassis.odom_enabled() && !chassis.pid_tuner_enabled()) {
        ...
        if (ez::as::page_blank_is_on(0)) {
          ...
          ez::screen_print("x: " + util::to_string_with_precision(chassis.odom_x_get()) +
                               ...
                               "\na: " + util::to_string_with_precision(chassis.odom_theta_get()));  // Don't override the top Page line
    ...
    pros::delay(ez::util::DELAY_TIME); 10;
  }
}
